    ...
    <div class="cart-main-area pt-95 pb-100 index-page">
        <div class="container">
            ...
            <div class="row">
                ...
                <p>
                    Дано:<br>
                    - <a href="{{ route('product-details') }}">Страница товара</a> с кнопкой "Добавить в корзину";<br>
                    - <a href="{{ route('basket') }}">Страница корзины</a> с кнопками изменения количества и удаления товара из корзины.
                </p>
                <p>
                    Нужно:<br>
